   ...
   <svg class="migaku-logo" width="30" height="39" viewBox="0 0 30 39">
    ...
    />
        ...
        self.activeFields = [
            ...
            "coloredhanzireading;all;Migaku {} Sentence;Standard;Target Word;back;{}",
            "coloredhover;all;Migaku {} Sentence;Standard;Definitions;back;{}",
            "coloredhanzi;all;Migaku {} Sentence;Standard;Variant;back;{}",

            "hanzi;all;Migaku {} Vocabulary;Standard;Target Word;front;{}",
            "coloredhanzireading;all;Migaku {} Vocabulary;Standard;Sentence;back;{}",
            "coloredhanzireading;all;Migaku {} Vocabulary;Standard;Target Word;back;{}",
            "coloredhover;all;Migaku {} Vocabulary;Standard;Definitions;back;{}",
            "coloredhanzi;all;Migaku {} Vocabulary;Standard;Variant;back;{}",

            "coloredhanzireading;all;Migaku {} Audio Sentence;Standard;Sentence;back;{}",
            "coloredhanzireading;all;Migaku {} Audio Sentence;Standard;Target Word;back;{}",
            "coloredhover;all;Migaku {} Audio Sentence;Standard;Definitions;back;{}",
            "coloredhanzi;all;Migaku {} Audio Sentence;Standard;Variant;back;{}",

            "coloredhanzireading;all;Migaku {} Audio Vocabulary;Standard;Sentence;back;{}",
            "coloredhanzireading;all;Migaku {} Audio Vocabulary;Standard;Target Word;back;{}",
            "coloredhover;all;Migaku {} Audio Vocabulary;Standard;Definitions;back;{}",
            "coloredhanzi;all;Migaku {} Audio Vocabulary;Standard;Variant;back;{}"
        ]
...
.migaku-translation, .migaku-variant{
   margin-top: 10px;
    margin-bottom: 10px;
}
...
@media (min-width: 500px) {
  .migaku-card--back .migaku-card-content {
    ...
    grid-gap: 10px;
    grid-template-areas:
    "word-audio word word word word word word word" "sentence-audio sentence sentence sentence sentence sentence sentence sentence" "variant variant variant variant variant variant variant variant" "translation translation translation translation translation translation translation translation" "definition definition definition definition definition definition definition definition";
  }
  ...
  .editableField[data-field="Variant"]{
    grid-area: variant;
  }
  ...
  .migaku-card--back .migaku-variant {
    grid-area: variant;
  }
...
"""
    ...
    def getModelList(self):
        modelList = []
        alternates = ["Chinese(CN)", "Chinese(TW)", "Cantonese"]
        for alternate in alternates:
            name = 'Migaku '+ alternate +' Sentence'
            fields = ['Sentence', 'Translation', 'Target Word', 'Definitions', 'Variant', 'Image', 'Sentence Audio', 'Word Audio']
    ...
    <div class="migaku-card migaku-card--back">
        ...
        <div class="migaku-card-content">
            ...
            <div class="migaku-variant ">{{Variant}}</div>
    ...
    '''
            ...
            name = 'Migaku '+ alternate +' Vocabulary'
            fields = ['Target Word', 'Sentence', 'Translation', 'Definitions', 'Variant', 'Image', 'Sentence Audio', 'Word Audio']
            front = '''<div class="migaku-header">
    %s
    </div>
    <div class="migaku-card migaku-card--front">
    ...
    '''
            ...
            modelList.append([name, fields, front%self.svg, back%self.svg])
            name = 'Migaku '+ alternate +' Audio Sentence'
            fields = ['Sentence', 'Translation', 'Target Word', 'Definitions', 'Variant', 'Image', 'Sentence Audio', 'Word Audio']
            front = '''<div class="migaku-header">
    %s
    </div>
    ...
    '''
            ...
            modelList.append([name, fields, front%self.svg, back%self.svg])
            name = 'Migaku '+ alternate +' Audio Vocabulary'
            fields = ['Target Word', 'Sentence', 'Translation', 'Definitions', 'Variant', 'Image', 'Sentence Audio', 'Word Audio']
            front = '''<div class="migaku-header">
    %s
    </div>
    ...
    def maybeAddActiveFieldsToConfig(self, name, reading):
        ...
        for af in self.activeFields:
            ...
            if namedAf not in activeFieldsConfig:
    ...
    def addExportTemplates(self, name):
        ...
        for addon in addons:
            ...
            if dirName in ["Migaku Dictionary", "1655992655"]:
                self.addExportTemplatesToConfig(dirName, name)
